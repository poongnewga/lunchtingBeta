...
class LocationAgreementScreen extends Component {
...
제 1장. 총 칙
제 1 조 (목적) 본 약관은 회원( 런치팅 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.)
이 런치팅 (이하 "회사"라고 합니다.)이 제공하는 런치팅 서비스(이하 "서비스"라고 합니다)를 이용함에
...
1. 상     호 : 런치팅
2. 대 표 자 : 조동근
3. 주     소 : 서울시 성북구 안암로 145 고려대학교 파이빌 S306호
2. 대표전화 : 010-5529-7795

부 칙
제1조 (시행일) 이 약관은 2017년 07월 24일 부터 시행한다.
제2조 위치정보관리책임자는 2017년 07월 24일 을 기준으로 다음과 같이 지정합니다.
1. 소     속 : 런치팅
2. 연 락 처 : 010-5529-7795
※ 기본 입력사항은 지원하고 있으나 상세한 항목수정은 파일로 다운로드 받아 수정하여야 합니다.
            `}</Text>
            </View>
          </View>
        </ScrollView>
...
export {LocationAgreementScreen};
